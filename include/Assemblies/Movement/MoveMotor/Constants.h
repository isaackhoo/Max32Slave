...
#define TIMEOUT_MULTIPLIER_5 1.2
#define TIMEOUT_MULTIPLIER_4 1.3
#define TIMEOUT_MULTIPLIER_3 1.5
#define TIMEOUT_MULTIPLIER_2 2
#define TIMEOUT_MULTIPLIER_1 3
...
#define POSITION_CONTINUOUS_CREEP_DELAY 35
